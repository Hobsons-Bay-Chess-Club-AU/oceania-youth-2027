        ...
        <div className="grid gap-5">
          {posts.map((post) => (
            <Link
              key={post.slug}
              href={`/news/${post.slug}`}
              className="rounded-[1.75rem] border border-slate-200 bg-[linear-gradient(180deg,#ffffff,#f8fbff)] p-6 shadow-[0_20px_50px_rgba(15,23,42,0.06)] transition-transform hover:-translate-y-0.5 md:p-8"
            >
