export const regulations = {
  ...
  sections: [
    ...
    { heading: "1.4 Default Time", paragraphs: ["A player forfeits the game if he/she hasn't appeared at his/her board within 30 minutes after the start of the game."] },
    {
      ...
      orderedList: ["Direct Encounter", "The greater number of wins", "Buchholz", "Buchholz Cut 1, Cut 2", "Sonnenborn Berger"],
    },
    {
