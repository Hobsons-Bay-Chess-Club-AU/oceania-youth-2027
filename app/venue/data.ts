export const venueData = {
  ...
  travelIntro:
    "Add a short overview here explaining where the venue is and why it is convenient for players and families.",
  byAir:
    "Airport and arrival placeholder. Replace this with the closest airport, transfer options, and expected travel times.",
  byTransport:
  ...
  accommodation: [
    ...
    { name: "Hotel placeholder two", address: "Accommodation address placeholder", distance: "Distance placeholder" },
    { name: "Hotel placeholder three", address: "Accommodation address placeholder", distance: "Distance placeholder" },
    {
    ...
    { name: "Accommodation placeholder five", address: "Accommodation address placeholder", distance: "Distance placeholder" },
    { name: "Accommodation placeholder six", address: "Accommodation address placeholder", distance: "Distance placeholder" },
    { name: "Accommodation placeholder seven", address: "Accommodation address placeholder", distance: "Distance placeholder" },
    { name: "Accommodation placeholder eight", address: "Accommodation address placeholder", distance: "Distance placeholder" },
  ],
  onSiteFoodIntro:
    "On-site food placeholder. Replace this with actual cafe hours, kiosks, or meal options.",
  onSiteFoodItems: [
